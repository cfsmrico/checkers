/*
 * Originally, this was chessboard.js v0.3.0 by Chris Oakman,
 *  but I modified somewhat so as to stick in checkers pieces.
 *  The pngs come  from sambaker's AGS-Sample repo
 */
...
var MINIMUM_JQUERY_VERSION = '1.7.0',
  ...
  START_FEN = '1p1p1p1p/p1p1p1p1/1p1p1p1p/8/8/P1P1P1P1/1P1P1P1P/P1P1P1P1',
...
function expandConfig() {
  ...
  if (cfg.hasOwnProperty('pieceTheme') !== true ||
    ...
    cfg.pieceTheme = 'img/ags-sample/{piece}.png';
  }
